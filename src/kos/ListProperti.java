 ...
 * @author PY7
 */
public class ListProperti extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("List Data Properti");
    ...
    private void btnPilihActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPilihActionPerformed
        ...
        Penyewaan.txIDBarang.setText(id);
        Penyewaan.txNamaBarang.setText(nama);
        Penyewaan.txHarga.setText(harga);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListProperti.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListProperti().setVisible(true);
            }
        });
    }
